...
Revision ID: 0be152f40f2b
Revises: 
Create Date: 2024-09-12 21:14:12.149533
...
def upgrade():
    ...
    sa.Column('developer_name', sa.String(length=60), nullable=True),
    ...
    sa.Column('min_os', sa.String(length=100), nullable=False),
